...
public class CreditingAmount extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userAmount>0)
		{
				...
				bankstatement.setTransection_type("Credit");
				...
				if(status)
				{
					pw.println("<center><h1>Credit Sucessfull!1</h1></center>");
				}
				else
				{
					pw.println("<center><h1>credit Not Sucessfull!1</h1></center>");
				}
